#!/usr/bin/env python3
"""Pair with Apple TV via Companion protocol to control AirPlay speaker volumes."""
...
async def main():
    ...
    pairing = await pyatv.pair(config, Protocol.Companion, loop)
    await pairing.begin()
